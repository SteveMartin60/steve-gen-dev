...
//..............................................................................
function findSidebarSVGElements()
{
    ...
    for (var i = 0; i < allElements.length; i++)
    {
        ...
        if (element.id === 'diagram-grid')
        {
            console.log('diagram-grid found');

            diagrams = allElements[i];

            xhttp.open("GET", "http://localhost:63342/Documentation/mesh-svg/bd-dev/diagram-grid.html", true);
            var x = xhttp.send();



            console.log('Send X: ' + xhttp.valueOf());
            console.log('Send X: ' + xhttp.response);
            console.log('Send X: ' + xhttp.responseText);
            console.log('Send X: ' + xhttp.responseType);
            console.log('Send X: ' + xhttp.status);
            console.log('Diagrams: ' + diagrams);
            console.log('Diagrams C: ' + getElementString(diagrams));
        }
...
*/
    ...
    //diagrams   = document.getElementById("diagram-grid");
    thumb      = document.getElementById("block-diagram-thumb");


    if (thumb)
    {
        console.log('Thumb Source: ' + thumb.src);
    }
