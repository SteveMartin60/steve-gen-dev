...
} = require('../../util-device-sheet/pins-standard');

const deviceSheetFilePath         = '../../../doc/ascii-device-sheets/';
const descriptionEnToDo           = 'descriptionEn_ToDo';
const descriptionZhToDo           = 'descriptionZh_ToDo';
const pinTypeToDo                 = 'pinType_ToDo';
const meshDocModuleInterfacesPath = '../../../doc/module-interfaces/';
...
//..............................................................................
function getModuleCVSFiles()
{
    var filesCSV = findFiles(pathModuleCsvDS, '.csv', 'Find MB CSV DS Files')
...
{
    var filesModuleDefs = findFiles(pathModuleDefs, '.js', 'Find MB Def Files')

    return filesModuleDefs;
}
//..............................................................................

//..............................................................................
function validateModuleDefs(moduleDef)
{
    var modulesObject = {};

    process.chdir('C:\\Dropbox (Mesheven)\\Git\\HW Master\\Libraries\\Symbols');

    console.log(process.cwd())

    const gitPath = '"C:/Dropbox (Mesheven)/Git/Documentation/git-v2.19.2-win-x64/cmd/git.exe"';
    const command = 'log MB0001.01.SchLib'
    const commandString = gitPath + ' ' + command;

    var child_process = require("child_process");

    var test = child_process.execSync("echo Hello World");

    var test = child_process.execSync(commandString);

    test = test.toString();

    // var test = require('child_process').execSync('"C:/Dropbox (Mesheven)/Git/Documentation/git-v2.19.2-win-x64/cmd/git.exe" log MB0001.01.SchLib', {stdio: 'inherit'});
    ...
    for (var i = 0; i < filesModuleDefs.length; i++)
    {
        var moduleID = filenameNoExtension(filesModuleDefs[i]);

        modulesObject[moduleID] = {};
        modulesObject[moduleID].def = filesModuleDefs[i];

    }

    var filesCSV        = getModuleCVSFiles();
    var filesModuleDefs = getModuleDefs    ();
