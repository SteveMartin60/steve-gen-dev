...
#..............................................................................
Function Get-InternalIpAddress
{
    $IPAddresses = @{}

    $IPAddresses = Get-NetIPAddress -AddressFamily IPv4 -AddressState Preferred | Select-Object IPAddress | Sort-Object InterfaceIndex

    foreach($IPAddress in $IPAddresses)
    {
        if (($IPAddress.IPAddress -match '192.168') -or ($IPAddress.IPAddress -match '10.0'))
        {
...
$IPAddress       = Get-InternalIpAddress
...
#..............................................................................
Write-Host "Getting System External Connection Report..."

PowerShell.exe -ExecutionPolicy Bypass -File "$SourcePath\system-external-connection.ps1"
#..............................................................................

#..............................................................................
Write-Host "Getting Firewall Report..."

PowerShell.exe -ExecutionPolicy Bypass -File "$SourcePath\system-firewall.ps1"
#..............................................................................
...
#..............................................................................
Write-Host "Getting TCP Connections Report..."

PowerShell.exe -ExecutionPolicy Bypass -File "$SourcePath\system-tcp-connections.ps1"
#..............................................................................
