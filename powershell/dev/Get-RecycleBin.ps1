...
{
    Return (New-Object -ComObject Shell.Application).NameSpace(0x0a).Items() |	Select-Object Name, Size, Path
}

$RecycleBinContents = Get-RecycleBin

CLS

$RecycleBinContents.Count