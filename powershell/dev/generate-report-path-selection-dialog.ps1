...
if (!$Debug)
{
    ...
    PowerShell.exe -ExecutionPolicy Bypass -File "\\192.168.1.169\IT Management\Powershell\Powershell Scripts\Reporting\system-installed-software.ps1"

    PowerShell.exe -ExecutionPolicy Bypass -File "\\192.168.1.169\IT Management\Powershell\Powershell Scripts\Reporting\system-memory.ps1"

    PowerShell.exe -ExecutionPolicy Bypass -File "\\192.168.1.169\IT Management\Powershell\Powershell Scripts\Reporting\system-environment.ps1"
